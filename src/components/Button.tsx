...
export default function Button({
    ...
    className={clsx("group relative text-slate-200 flex w-fit items-center justify-center overflow-hidden rounded-md border-2 border-slate-900 bg-slate-700 px-4 py-2 font-bold transition-transform ease-out hover:scale-105 ", className)}>
